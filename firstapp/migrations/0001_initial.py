# Generated by Django 5.0.1 on 2024-03-03 08:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('latitude', models.CharField(default='22.7155422', max_length=20)),
                ('longitude', models.CharField(default='75.8435895', max_length=20)),
                ('area', models.IntegerField(default=1000)),
                ('secretToken', models.CharField(default='abhishek123', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Admin',
